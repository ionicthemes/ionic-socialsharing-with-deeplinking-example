...
var _View_AboutPage0 = (function (_super) {
    ...
    _View_AboutPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_12 = this.renderer.createText(this._el_11, 'This is an example to show how to use DeepLinks and Social Sharing in your Ionic apps', null);
        this._text_13 = this.renderer.createText(null, '\n  ', null);
        this._el_14 = this.renderer.createElement(null, 'p', null);
        this._text_15 = this.renderer.createText(this._el_14, 'Check more awesome tutorials ', null);
