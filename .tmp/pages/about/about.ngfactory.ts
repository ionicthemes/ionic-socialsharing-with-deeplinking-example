...
class _View_AboutPage0 extends import1.AppView<import3.AboutPage> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_12 = this.renderer.createText(this._el_11,'This is an example to show how to use DeepLinks and Social Sharing in your Ionic apps',(null as any));
    this._text_13 = this.renderer.createText((null as any),'\n  ',(null as any));
    this._el_14 = this.renderer.createElement((null as any),'p',(null as any));
    this._text_15 = this.renderer.createText(this._el_14,'Check more awesome tutorials ',(null as any));
    this._el_16 = this.renderer.createElement(this._el_14,'a',(null as any));
    this.renderer.setElementAttribute(this._el_16,'href','www.ionicthemes.com/tutorials');
